		...
		<section>
            ...
            <?php 
                if(isset($_POST['send_email'])){
                    ...
                    $to = 'twotwentyfour@protonmail.com';
            ...
            <p>
                <?php
                    if (isset($msg)) { 
                        $msg .= "<br><a href='index.php'>Return to Home Page</a>";
                        echo $msg;
                    }
                ?>
            </p>
            ...
            <table align="left">
                <form name="form1" action="<?php $_SERVER['PHP_SELF']?>" method="post" onsubmit="return checkForm()">
                    <tr>
                        <th>Name:</th>
                        <td><input type="text" name="name" id="name" value=""><br>
                    ...
                    <tr>
                        <th>Message:</th>
                        <td><textarea name="message" id="message" rows="8" cols="40"></textarea><br>
                            <span style="color: red;" id="messagespan"></span>               
                        </td>
                    </tr>
                    <tr>
                        <td> </td><td><input type="submit" name="send_email" id="" value="Send Email Message"></td>
                    </tr>
                </form>
            </table>
		</section>
